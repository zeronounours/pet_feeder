...
if (WITH_DECORATION) {
    %translate([0, spinner_start_y + motor_attach_total_height, tube_radius_o]) rotate([-90, 0, 0]) spinner();
    ...
    %translate([0, spinner_start_y + motor_attach_total_height, tube_radius_o]) rotate([-90, 0, 0]) motor_attach();
